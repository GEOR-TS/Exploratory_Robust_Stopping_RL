...
class PE_call(nn.Module):
    def __init__(self, d, total_time, n_time_steps, K, r, dividend, sigma, strike, x_0, lambda_temp, epsilon,
        ...
        self.dt = total_time / n_time_steps # width of time mesh
        self.K = K # penalty factor
        self.r = r # interest rate
        self.dividend = dividend # dividend rate (training environment)
        self.sigma = sigma # volatility
        self.strike = strike # strike price
        self.x_0 = x_0 # initial price
        self.lambda_temp = lambda_temp # temperature parameter
        self.epsilon = epsilon # ambiguity degree

        self.hidden_layers = hidden_layers # hidden layer number
        self.hidden_dim = hidden_dim # width of network
...
class Policy_Iteration:
    def __init__(self, d, total_time, n_time_steps, K, r, dividend, sigma, strike, x_0, lambda_temp, epsilon, device=torch.device("cpu"),
                 hidden_layers=3, hidden_dim=64, lr=0.01, model_save_flag=1):
